...
static void resync_selection          (GtkCList      *clist,
			               GdkEvent      *event);
void sync_selection            (GtkCList      *clist,
	                               gint           row,
                                       gint           mode);
...
gint get_selection_info        (GtkCList       *clist,
				       gint            x,
				       gint            y,
				       gint           *row,
				       gint           *column);
...
static void set_column_title_active (GtkCList  *clist,
				     gint       column,
				     gboolean   active);
void column_button_create    (GtkCList  *clist,
				     gint       column);
static void column_button_clicked   (GtkWidget *widget,
				     gpointer   data);

/* Adjustments */
void adjust_adjustments        (GtkCList       *clist,
...
GtkCListColumn *columns_new (GtkCList      *clist);
static void column_title_new       (GtkCList      *clist,
			            gint           column,
			            const gchar   *title);
static void columns_delete         (GtkCList      *clist);
GtkCListRow *row_new        (GtkCList      *clist);
void row_delete             (GtkCList      *clist,
			            GtkCListRow   *clist_row);
static void set_cell_contents      (GtkCList      *clist,
				    ...
				    GdkPixmap     *pixmap,
				    GdkBitmap     *mask);
gint real_insert_row        (GtkCList      *clist,
				    gint           row,
				    gchar         *text[]);
void real_remove_row        (GtkCList      *clist,
				    gint           row);
void real_clear             (GtkCList      *clist);

/* Sorting */
gint default_compare        (GtkCList      *clist,
			            gconstpointer  row1,
			            gconstpointer  row2);
...
guint clist_signals[LAST_SIGNAL] = {0};
