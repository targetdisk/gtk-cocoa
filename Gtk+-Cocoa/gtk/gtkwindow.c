...
void gtk_window_unset_transient_for         (GtkWindow  *window);
...
GtkWindowGeometryInfo* gtk_window_get_geometry_info (GtkWindow *window,
							    gboolean   create);
...
gtk_window_class_init (GtkWindowClass *klass)
{
  ...
  widget_class->client_event = NULL;
...
gtk_window_move_resize (GtkWindow *window)
{
   ...
   */
  if (hints_changed)
    ;//gdk_window_set_geometry_hints (widget->window, &new_geometry, new_flags);
...
void
gtk_window_super_destroy(GtkObject *object)
{
