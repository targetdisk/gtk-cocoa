...
void gtk_entry_size_request        (GtkWidget         *widget,
...
void gtk_entry_grow_text           (GtkEntry          *entry);
static void gtk_entry_insert_text         (GtkEditable       *editable,
					   const gchar       *new_text,
					   gint               new_text_length,
					   gint              *position);
void gtk_entry_delete_text         (GtkEditable       *editable,
					   gint               start_pos,
					   gint               end_pos);
...
void gtk_entry_recompute_offsets   (GtkEntry          *entry);
