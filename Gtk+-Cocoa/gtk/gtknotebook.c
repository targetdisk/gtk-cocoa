...
void gtk_notebook_size_allocate       (GtkWidget        *widget,
...
void gtk_notebook_real_remove         (GtkNotebook      *notebook,
					      GList            *list);
static void gtk_notebook_update_labels       (GtkNotebook      *notebook);
static gint gtk_notebook_timer               (GtkNotebook      *notebook);
gint gtk_notebook_page_compare        (gconstpointer     a,
					      gconstpointer     b);
gint  gtk_notebook_real_page_position (GtkNotebook      *notebook,
					      GList            *list);
GList * gtk_notebook_search_page      (GtkNotebook      *notebook,
					      GList            *list,
					      gint              direction,
...
void gtk_notebook_pages_allocate      (GtkNotebook      *notebook,
					      GtkAllocation    *allocation);
...
void gtk_notebook_switch_page         (GtkNotebook      *notebook,
					      GtkNotebookPage  *page,
					      gint              page_num);
...
*/
    case GTK_POS_TOP:
      ...
      event.area.height = (page->allocation.height); //+ widget->style->klass->ythickness);
/*
      if (page != notebook->cur_page)
...
*/
    case GTK_POS_LEFT:
      event.area.width = (page->allocation.width); // + widget->style->klass->xthickness);
