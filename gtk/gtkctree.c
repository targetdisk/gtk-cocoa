...
static void set_cell_contents           (GtkCList      *clist,
					 ...
					 GdkPixmap     *pixmap,
					 GdkBitmap     *mask);
void set_node_info               (GtkCTree      *ctree,
					 GtkCTreeNode  *node,
					 const gchar   *text,
					 guint8         spacing,
					 ...
					 gboolean       is_leaf,
					 gboolean       expanded);
GtkCTreeRow *ctree_row_new             (GtkCTree      *ctree);
...
static void real_row_move               (GtkCList      *clist,
					 gint           source_row,
					 gint           dest_row);
void gtk_ctree_link              (GtkCTree      *ctree,
					 GtkCTreeNode  *node,
					 GtkCTreeNode  *parent,
...
static void select_row_recursive        (GtkCTree      *ctree, 
					 GtkCTreeNode  *node, 
					 gpointer       data);
static gint ctree_real_insert_row             (GtkCList      *clist,
					 gint           row,
					 gchar         *text[]);
static void ctree_real_remove_row             (GtkCList      *clist,
					 gint           row);
...
void column_auto_resize          (GtkCList       *clist,
					 GtkCListRow    *clist_row,
					 gint            column,
					 gint            old_width);
...
guint ctree_signals[LAST_SIGNAL] = {0};
...
gtk_ctree_class_init (GtkCTreeClass *klass)
{
  ...
  clist_class->insert_row = ctree_real_insert_row;
  clist_class->remove_row = ctree_real_remove_row;
