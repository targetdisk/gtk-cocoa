...
GdkPixmap   *default_icon_pixmap = NULL;
GdkPixmap   *default_icon_mask = NULL;
GdkColormap *default_icon_colormap = NULL;
gint         default_icon_hot_x;
gint         default_icon_hot_y;
...
void      gtk_drag_dest_realized       (GtkWidget          *widget);
